...
function Button({children, attributes}: {
    ...
    return <button className={"btn " + attributes.className} id={attributes.id} onClick={clickEventHandler}>{children}</button>
}
...
function ContactButton(): JSX.Element {
    ...
    return <PrimaryButton attributes={{className: "contact_btn", id:'contact'}}>
